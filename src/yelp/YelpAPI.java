...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "UpO1TvcK_s4mtnBavMEtsg";
    private static final String CONSUMER_SECRET = "s-Yqc05Ak2VHBuuPA_zqXe4Hl1w";
    private static final String TOKEN = "kLtZ7ipX0TBdVvXZBANfBjHGR-B5NdCG";
    private static final String TOKEN_SECRET = "tMfgF9gACTA7tBwTb28rxyUKcgs";
